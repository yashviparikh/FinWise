...
export default function Dashboard() {
    ...
    const fetchData = async () => {
      ...
      try {
        const res = await axios.get(
          `http://127.0.0.1:5000/dashboard/${uid}`,
  ...
  return (
    !uid ? (
      <LoginPrompt message="Sign in to view your dashboard and analytics." />
    ) : (
    <motion.div
    ...
    >
      ...
      <div className="dash__header">
        ...
        <div className="header-tools">
          ...
          <button
            className="export-btn"
            onClick={() => uid && window.open(`http://127.0.0.1:5000/dashboard/${uid}/export`)}
          >
